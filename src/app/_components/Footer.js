                    ...
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <Link href="/restaurant" className="flex items-center">
                                ...
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Go to Restaurant Log in Page</span>
                            </Link>
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <Link href="https://github.com/Haresh9996/Food-delivery-app" className="hover:underline ">Github</Link>
                                    </li>
                                    <li>
